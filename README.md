...
```bash
git clone https://github.com/eaff/dotfiles.git && cd dotfiles && source bootstrap.sh
```
...
```bash
cd; curl -#L https://github.com/eaff/dotfiles/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh,.osx,LICENSE-MIT.txt}
```
...
GIT_AUTHOR_NAME="Eduardo Farias"
GIT_COMMITTER_NAME="$GIT_AUTHOR_NAME"
git config --global user.name "$GIT_AUTHOR_NAME"
GIT_AUTHOR_EMAIL="eaff.pt+git@NOTgmailNOT:).com"
...
[welcome](https://github.com/eaff/dotfiles/issues)!
...
* @mathiasbynens [mathiasbynens] (https://github.com/mathiasbynens/dotfiles) from the foundation for my dot files
